...
export type User = {
  ...
  claims: Scalars["StringMap"]["output"];
...
export type CurrentUserQuery = { __typename?: "Query", currentUser: { __typename?: "User", id: string, subject: string, issuer: string, admin: boolean, groups: Array<string>, claims: any } };
...
export type WatchUsersSubscription = { __typename?: "Subscription", users: { __typename?: "Page", count: number, more: boolean, results: Array<{ __typename: "Group" } | { __typename: "Jump" } | { __typename: "User", id: string, subject: string, issuer: string }> } };
